                ...
                <div className="offcanvas__content">
                    <div className="offcanvas__top mb-50 d-flex justify-content-between align-items-center">
                        <div className="offcanvas__logo logo">
                            <Link href="/">
                            <Image src={Logo} alt="logo" style={{width:"250px",height:"60px"}}/>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="offcanvas__contact">
                        ...
                        <div className="offcanvas__contact-content d-flex">
                            ...
                            <a href="https://www.google.com/maps/search/86+Road+Broklyn+Street,+600+New+York,+USA/@40.6897806,-74.0278086,12z/data=!3m1!4b1">405, Samiksh Landmark, near Maa Vihar colony, Indore(M.P.), India</a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="mailto:needhelp@company.com">info@asparrowtech.com  </a>
                            </div>
                        </div>
                        <div className="offcanvas__contact-content d-flex">
                            <div className="offcanvas__contact-content-icon">
                            ...
                            <div className="offcanvas__contact-content-content">
                            <a href="tel:01310-069824"> +91 8815410181</a>
                            </div>
                        </div>
                    </div>
                    <div className="offcanvas__social"> 
                        <a className="icon facebook" href="https://join.skype.com/invite/uKe9jeFZPZSs" target='__blank'><i className="fab fa-skype"></i></a>
                        {/* <a className="icon twitter" href="#"><i className="fab fa-twitter"></i></a> */}
                        {/* <a className="icon youtube" href="#"><i className="fab fa-youtube"></i></a> */}
                        <a className="icon linkedin" href="https://www.linkedin.com/in/asparrow-tech-b72b621a3/" target='__blank'><i className="fab fa-linkedin"></i></a>
                    </div>
                </div>
                </div>
            </div>
