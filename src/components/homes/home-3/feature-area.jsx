...
const feature_data = [
    {
        ...
        description: <>Swift, timely replies ensuring prompt and effective communication for optimal issue resolution and satisfaction.</>,
    },
    {
        id: 2, 
        img: feature_icon_2,
        title: "perfect solutions",
        description: <>Tailored, precise resolutions addressing specific needs, providing a perfect solution for optimal outcomes and satisfaction.</>,
    },
    {
        id: 3, 
        img: feature_icon_3,
        title: "No Geek Speeks",
        description: <>Simplifying tech talk for everyone, avoiding jargon to make information easily understandable and relatable.</>,
    },
    {
        id: 4, 
        img: feature_icon_4,
        title: "100% Satisfaction",
        description: <>Ensuring every client or customer is delighted with our services, guaranteeing complete satisfaction and happiness.</>,
    },
    // {
    //     id: 5, 
    //     img: feature_icon_1,
